...
app.post("/signup",function(req,res){
  ...
  if(!re.test(password)){
    const err="The password entered must contain atleast one uppercase, lowercase and number";
    ...
    User.register({email:email, firstName:firstName, lastName:lastName},password,function(err,user){
      if(err){
        res.render("signup",{err})
      }else{
